...
class Auth_Login_Simple extends \Auth_Login_Driver
{
	/**
	...
	{
		// fetch the email and login hash from the session
	...
	{
		$email = trim($email) ?: trim(\Input::post(\Config::get('simpleauth.username_post_key', 'email')));
